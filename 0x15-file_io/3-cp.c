...
/**
 * close_file - will close file descriptors
...
/**
 * main - will copy the contents of a file to another file
 * @argc: number of arguments suplied to the program
